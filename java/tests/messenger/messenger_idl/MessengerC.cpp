...
::CORBA::Boolean operator<< (TAO_OutputCDR &strm, Messenger::Choice _tao_enumerator)
{
  return strm << static_cast< ::CORBA::ULong> (_tao_enumerator);
}

::CORBA::Boolean operator>> (TAO_InputCDR &strm, Messenger::Choice & _tao_enumerator)
{
  ...
  if (_tao_success)
    {
      _tao_enumerator = static_cast<Messenger::Choice> (_tao_temp);
    }
    ...
    const Messenger::Message &_tao_aggregate)
{
  return
    ...
    (strm << _tao_aggregate.words.in ()) &&
    (strm << _tao_aggregate.achoice);
}
